...
// Generated: 2026-03-07T10:31:42.133004
...
// Frame 1 diff: 5 bytes
const uint16_t plot_diff_1_count = 5;
const uint16_t plot_diff_1_offsets[] PROGMEM = {
    16, 32, 36, 52, 64
};
const uint8_t plot_diff_1_values[] PROGMEM = {
    0xB0, 0xC6, 0x82, 0xC0, 0xD4
};

// Frame 2 diff: 8 bytes
const uint16_t plot_diff_2_count = 8;
const uint16_t plot_diff_2_offsets[] PROGMEM = {
    12, 16, 20, 24, 32, 40, 52, 64
};
const uint8_t plot_diff_2_values[] PROGMEM = {
    0x80, 0x80, 0xC0, 0x84, 0x86, 0xC3, 0x80, 0xEA
};

// Frame 3 diff: 8 bytes
const uint16_t plot_diff_3_count = 8;
const uint16_t plot_diff_3_offsets[] PROGMEM = {
    24, 28, 32, 36, 40, 44, 48, 49
};
const uint8_t plot_diff_3_values[] PROGMEM = {
    0x80, 0x80, 0x80, 0x80, 0xC0, 0x80, 0x80, 0x00
};

// Frame 4 diff: 12 bytes
const uint16_t plot_diff_4_count = 12;
const uint16_t plot_diff_4_offsets[] PROGMEM = {
    53, 57, 60, 61, 65, 69, 73, 77, 81, 85, 89, 93
};
const uint8_t plot_diff_4_values[] PROGMEM = {
    0x00, 0x00, 0xFF, 0xFF, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10
};

// Frame 5 diff: 11 bytes
const uint16_t plot_diff_5_count = 11;
const uint16_t plot_diff_5_offsets[] PROGMEM = {
    93, 97, 98, 101, 102, 105, 106, 109, 110, 113, 114
};
...
const uint16_t plot_diff_6_count = 15;
const uint16_t plot_diff_6_offsets[] PROGMEM = {
    51, 54, 55, 58, 62, 63, 66, 67, 70, 74, 78, 82,
    86, 90, 94
};
const uint8_t plot_diff_6_values[] PROGMEM = {
    0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xAA, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

// Frame 7 diff: 7 bytes
const uint16_t plot_diff_7_count = 7;
...
const uint8_t plot_diff_10_values[] PROGMEM = {
    0x98, 0x8C, 0x84, 0x86, 0xC2, 0x83, 0x81, 0x81
};

// Frame 11 diff: 14 bytes
const uint16_t plot_diff_11_count = 14;
const uint16_t plot_diff_11_offsets[] PROGMEM = {
    49, 53, 57, 60, 61, 65, 69, 73, 77, 81, 85, 89,
    93, 97
};
const uint8_t plot_diff_11_values[] PROGMEM = {
    0x80, 0x80, 0x80, 0xFE, 0xDF, 0x4A, 0x40, 0x60, 0x20, 0x20, 0x30, 0x10, 0x18, 0x08
};
...
const uint8_t plot_diff_12_values[] PROGMEM = {
    0x08, 0x0C, 0x0C, 0x18, 0x06, 0x10, 0x03, 0x70, 0x01, 0xC0
};

// Frame 13 diff: 15 bytes
const uint16_t plot_diff_13_count = 15;
const uint16_t plot_diff_13_offsets[] PROGMEM = {
    55, 58, 59, 62, 63, 66, 67, 70, 74, 78, 82, 86,
    90, 94, 98
};
const uint8_t plot_diff_13_values[] PROGMEM = {
    0x80, 0x01, 0x80, 0xF9, 0x3F, 0xA9, 0x55, 0x03, 0x02, 0x02, 0x06, 0x04, 0x04, 0x0C, 0x08
};

// Frame 14 diff: 10 bytes
const uint16_t plot_diff_14_count = 10;
const uint16_t plot_diff_14_offsets[] PROGMEM = {
    27, 31, 35, 39, 43, 47, 51, 54, 59, 67
};
const uint8_t plot_diff_14_values[] PROGMEM = {
    0x20, 0x20, 0x60, 0x40, 0x40, 0xC0, 0x80, 0x01, 0x00, 0x6A
};

// Frame 15 diff: 3 bytes
const uint16_t plot_diff_15_count = 3;
...
const uint16_t plot_diff_counts[] PROGMEM = { 5, 8, 8, 12, 11, 15, 7, 2, 5, 8, 14, 10, 15, 10, 3, 2, 0, 0 };
